...
async function main() {
    ...
    try {
        ...
        const registerResponse = await contract.submitTransaction('creditRegistration', JSON.stringify(jsonPayload));

        let credit = Credit.fromBuffer(registerResponse);

        console.log(`Credit Owner ${credit.owner} registered with ${credit.credit} credits successfully. Id = ${credit.id}`);
